...
import "https://d.kstore.dev/download/12194/libs/jsencrypt.js";
import "https://d.kstore.dev/download/12194/libs/node-rsa.js";
import "https://d.kstore.dev/download/12194/libs/pako.min.js";
import 模板 from "https://d.kstore.dev/download/12194/libs/模板.js";
import {
    gbkTool
} from "https://d.kstore.dev/download/12194/libs/gbk.js";
import "https://d.kstore.dev/download/12194/libs/json5.js";
import "https://d.kstore.dev/download/12194/libs/jinja.js";
...
function get_tab_index(vod) {
    let obj = {};
    vod.vod_play_from.split("💕琉芸👉+$$$").forEach((it, index) => {
        obj[it] = index
    });
    return obj
}
...
function vodDeal(vod) {
    let vod_play_from = vod.vod_play_from.split("💕琉芸👉+$$$");
    let vod_play_url = vod.vod_play_url.split("💕琉芸👉+$$$");
    ...
    vod.vod_play_from = tab_list.join("💕琉芸👉+$$$");
    vod.vod_play_url = play_ordered_list.join("💕琉芸👉+$$$");
    return vod
}
